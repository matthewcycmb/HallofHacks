...
const OPENER = {
  ...
  "temp-sqyptg": "your character living on and talking like you after you log off is such a cool idea",
  "dial-4rqzc3": "the fact that you were actually stranded and got the bots to talk a hotel down to $158 is hilarious",
  ...
  "yes-or-yes": "letting actual fish make your decisions and having the computer just go do it is so funny",
  screwyouikea: "turning an IKEA manual into a 3D thing you can spin around and follow is genuinely so smart",
  longshot: "200 agents rebuilding Minecraft overnight from one prompt is wild",
...
contacts.forEach((c, i) => {
  ...
  // LinkedIn invitations cap the note at 300 chars, so this just opens the door
  // (the reaction lands in the full DM once they accept).
  const note =
    `Hey ${fn}! been going through winning hackathon projects and ${c.project} stood out, ` +
    `so I added it to Hall of Hacks — my site collecting the best ones (hallofhackss.com). ` +
