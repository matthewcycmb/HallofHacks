...
const MANIFEST = [
  ...
  // ---- 50-roster expansion (June 2026; scouted via CURATION.md gates) ----
  { slug: "maestro-n0uqyz", hackathon: "TreeHacks", year: 2026, award: "Best Musical Hack",
    blurb: "Point a camera at a broom and strum: hand tracking turns any object into a playable instrument, then a full song." },
  { slug: "viniclip", hackathon: "ConUHacks", year: 2026, award: "1st Place Overall",
    blurb: "An editor that deletes your stumbles while you're still recording — press stop and the video is already done." },
  { slug: "plant-hopper", hackathon: "Hack the Valley", year: 2025, award: "1st Place Overall",
    blurb: "A water-gun turret that finds thirsty houseplants and squirts each exactly enough." },
  { slug: "readable-ai-braille-printer", hackathon: "TreeHacks", year: 2025, award: "Best Hardware Hack",
    blurb: "A braille printer for under $15 on a stock 3D printer — 100x cheaper than commercial embossers." },
  { slug: "fable-br8e1d", hackathon: "TreeHacks", year: 2025, award: "OpenAI: Most Creative",
    blurb: "A storybook steered by your brainwaves: focus and calm reshape plot, art, and sound live via a consumer EEG headband." },
  { slug: "vibe-director", hackathon: "Hack the North", year: 2025, award: "Finalist",
    blurb: "Make a film by walking around a 3D studio and talking to the AI staff — the interface is the wow, not the generation." },
  { slug: "signhero", hackathon: "SwampHacks", year: 2026, award: "Best Overall",
    blurb: "Sign-language rhythm game: letters fall like notes, the webcam judges your handshapes in time with the music." },
  { slug: "reeljobs", hackathon: "DeltaHacks", year: 2026, award: "3rd Place Overall",
    blurb: "Job listings as a swipeable short-video feed with one-tap apply — the demo narrators are Obama and Stewie." },
  { slug: "the-unspillable", hackathon: "Bitcamp", year: 2026, award: "Best Hardware Hack",
    blurb: "Self-leveling spoon for tremor patients: two motors counteract the shake in real time — a $300 product rebuilt in a weekend." },
  { slug: "coach-bob", hackathon: "Hack the North", year: 2025, award: "Finalist",
    blurb: "AR punching bag with glowing strike targets — it senses hit force from the wobble, and Bob trash-talks you through the workout." },
  { slug: "wateryourdoin", hackathon: "McHacks", year: 2026, award: "2nd Place Overall",
    blurb: "Catches prompts a web search could answer and shows the skipped queries as drinking water saved." },
  { slug: "digital-physical-darts-wii-darts", hackathon: "Cal Hacks 12.0", year: 2025, award: "Best Beginner Hack",
    blurb: "A real dart with a motion sensor inside: swing your arm and the throw lands on a digital board — a homemade Wii controller." },
  { slug: "project-lend", hackathon: "TreeHacks", year: 2026, award: "Anthropic Track Winner",
    blurb: "An autonomous food bank: donors text, a robot arm sorts, agents schedule — about 100 lbs actually delivered to shelters in one weekend." },
  { slug: "lume-zrlypk", hackathon: "HackPrinceton", year: 2025, award: "Education Track Winner",
    blurb: "Voice tutor for seniors that draws a glowing highlight on the actual button to click — guidance on the real screen, not a chatbot." },
  { slug: "replay-wq5isz", hackathon: "Bitcamp", year: 2026, award: "App Dev Track Winner",
    blurb: "Replay Mod for reality: iPhone LiDAR plus two arm sensors record a room you can scrub and fly through in 3D." },
  { slug: "taqr", hackathon: "StormHacks", year: 2025, award: "UN SDG Challenge Winner",
    blurb: "Laser tag where ammo is litter: scan real trash to reload — cleanup becomes the game loop." },
  { slug: "archemy", hackathon: "Hack the North", year: 2025, award: "Snap AR Winner",
    blurb: "Infinite Craft in midair: grab AR elements with bare hands and smash them into new inventions." },
];
