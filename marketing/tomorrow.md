# Tomorrow — outreach run sheet

Work top to bottom. Each block has the link and the exact text to paste — tick the `[ ]` as you go.

**The one rule:** before you send each, add one line only you could write (a specific thing you noticed in their demo). That single human line is what turns a polite nod into a reshare.

First: open https://hallofhackss.com/featured-badge.svg once to confirm it loads (the README badge offer depends on it).

---

## Step 1 — Twitter DMs (3) — do these first, they're instant

Open the profile, paste, send. If their DMs are closed, message them on LinkedIn instead (in `top15-contacts.md`).

### [ ] 2. Shepherd — Tony Wang
...
## Step 2 — LinkedIn (12) — Connect → Add a note → paste

**Pace these** — don't fire them all in a couple minutes (LinkedIn flags bursts). Heads up: free LinkedIn caps personalized-note invites (often ~5/month), so if it stops letting you add a note, the same text works as an email/Devpost message (channels in `top15-contacts.md`), or connect without a note and send it once they accept.

### [ ] 1. FaceTimeOS — Calvin Lu
**Connect + add note**: https://www.linkedin.com/in/calvin-lu
...
### [ ] 3. Identity Matrix — Alvina Yang
**Connect + add note**: https://www.linkedin.com/in/alvina-yang
...
### [ ] 4. DIAL(*) — John Connell
**Connect + add note**: https://www.linkedin.com/in/john-connell-cs
...
### [ ] 5. ROSS — Jonathan Shanmuganantham
**Connect + add note**: https://www.linkedin.com/in/jonathanshan1
...
### [ ] 6. Orca — Robert Yin
**Connect + add note**: https://www.linkedin.com/in/yin-robert
...
### [ ] 7. Dance CV — Joseph Deng
**Connect + add note**: https://www.linkedin.com/in/joseph-deng-786a0223a
...
### [ ] 8. YES? or YES! — Jason Zeng
**Connect + add note**: https://www.linkedin.com/in/jasonzeng0
...
### [ ] 9. ScrewYouIKEA.com — Donara Galstyan
**Connect + add note**: https://www.linkedin.com/in/donara-galstyan
...
### [ ] 11. Shop-A-Sketch — Claire Zhang
**Connect + add note**: https://www.linkedin.com/in/claire-zhang-985410301
...
### [ ] 12. ScamShield — Caleb Wiese
**Connect + add note**: http://www.linkedin.com/in/caleb-wiese
...
### [ ] 13. Snowy Day — Aidan Chow
**Connect + add note**: https://www.linkedin.com/in/aidan-chow-7a8242202
...
### [ ] 14. Wordhawk — Cindy Yang
**Connect + add note**: https://www.linkedin.com/in/2023cyang
...
- Mark each person in `outreach-tracker.csv` as you send.
- Set a reminder ~4 days out: one light follow-up to non-responders, then move on.
- Once someone accepts/replies on LinkedIn, send the longer "Short DM" from `top15-contacts.md` as the warm second touch (it has the badge offer).
